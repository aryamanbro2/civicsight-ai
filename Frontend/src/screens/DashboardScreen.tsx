                ...
                {reports.length > 0 && (
                    <View style={styles.currentIssueCard}>
                        <View style={styles.issueHeader}>
                            ...
                            <View style={[styles.priorityBadge, { backgroundColor: getPriorityColor(reports[0].priority) }]}>
                    ...
                    {reports.slice(1).map((report) => (
                        <View key={report.id} style={styles.reportItem}>
                            <View style={styles.reportInfo}>
                                <View style={[styles.reportDot, { backgroundColor: getPriorityColor(report.priority) }]} />
